...
# usamos un script de Powershell para convertir todos los archivos XLSX de las rutas indicadas 
# por la variable de entorno RUTAS_XLSX a CSV y dejarlos en la carpeta a la que pertenecen, 
# pero no se ejecuta hasta que se inicia un contenedor
WORKDIR /
